module OmronBot
  class Config
    ...
    def self.valid?
      return false unless File.exist?("#{Dir.home}/.omron_bot")
      File.open("#{Dir.home}/.omron_bot", 'r') do |f|
    ...
    def self.config_file
      @config ||= JSON.parse(File.read("#{Dir.home}/.omron_bot"), symbolize_names: true)
    end
  end
end
